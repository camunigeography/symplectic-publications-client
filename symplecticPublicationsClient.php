...
class symplecticPublicationsClient extends frontControllerApplication
{
	...
	public function databaseStructure ()
	{
		return "
			...
			) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table of publications for each user';
			...
			CREATE TABLE `publications` (
			  ...
			  `savedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Automatic timestamp'
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Publications';
			...
			CREATE TABLE `userorganisations` (
			  ...
			  INDEX userId (userId)
			) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table of organisations of each user';
			...
			CREATE TABLE `users` (
			  ...
			  `savedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Automatic timestamp'
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table of data of users who have publications';
			...
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table of publications to be excluded for a group';
		";
	}
